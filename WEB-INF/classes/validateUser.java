...
public class validateUser extends HttpServlet{
   ...
   public void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
	  ...
	  String destPage = "quiz_login1.html";	
      ...
      try {
         ...
         PreparedStatement ps=conn.prepareStatement("select * from quizlogs where username=?");  
         ...
         if(status){
			...
			ps=conn.prepareStatement("delete from passwords where username=?");  
			ps.setString(1,username);  
   ...
   public void setMailServerProperties(){
	...
	public MimeMessage draftEmailMessage(String username, String password) throws AddressException, MessagingException{
        ...
        String emailSubject = "Quiz password from eq club";
