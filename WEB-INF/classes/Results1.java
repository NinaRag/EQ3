...
public class Results1 extends HttpServlet{
...
//		 out.println(arr);
		...
		PreparedStatement st = conn.prepareStatement("insert into quizlogs1 values(?, ?, ?)");
		...
		if(stat > 0){
			...
			for(StudentInfo p : stu){p.setselfEsteemScore(resi);}
